...
class AuditLogsExtractor extends BaseExtractor {
  async extract(parameters) {
    ...
    return [await this.writeJson('AzureAD_AuditLogs.json', data, { startDate, endDate })];
  }
}

module.exports = AuditLogsExtractor;